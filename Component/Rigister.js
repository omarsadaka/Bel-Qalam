    ...
    render(){
        ...
        <SafeAreaView style={styles.container}>
            ...
            <Spinner
               ...
               style={[styles.input,{fontSize:this.normalize(17),}]}
               />
              <View style={[styles.viewRow,this.state.lang==='AR'?styles.row:styles.row_reserve,{}]}>
              <Icon name="caret-down" size={18} color="#707070" style={{position:'absolute',left:5}} />
               <View style={{width:'100%',alignItems:'center',marginEnd:'20%'}}  >
              <Picker
                  style={{width:'100%',height:'100%',alignItems:'center',color:'#000',justifyContent:'center',fontFamily:'segoe',backgroundColor:'transparent'}}
              ...
              <Icon name="caret-down" size={18} color="#707070" style={{position:'absolute',left:5}} />
               <View style={{width:'100%',marginEnd:'20%'}}  >
              <Picker
                  style={{width:'100%',height:'100%',alignItems:'center',color:'#000',justifyContent:'center',fontFamily:'segoe',backgroundColor:'transparent'}}
